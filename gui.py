...
def main_box(details,*args):
    ...
    for i in range(0,len(details)):
        ...
        Button(master,text="Edit",relief=GROOVE,font="Tahoma 12",fg="white",bg="#404042",width=8,command=lambda: edit_box(details[i])).grid(row=i+1,column=3,padx='10px',pady='5px')
        Button(master,text="Use",relief=GROOVE,font="Tahoma 12",fg="white",bg="#404042",width=8).grid(row=i+1,column=4,padx='10px',pady='5px')
